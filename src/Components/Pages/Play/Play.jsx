  ...
  renderSudokuSection() {
    ...
    return([
      ...
      <div className="btn-section">
        <Button class="play_btn" margin="10" onClick={ () => { this.resetSudoku() }}>Reset Sudoku</Button>
        <Button class="play_btn" margin="10" onClick={ () => { this.checkSudoku() }}>Check the Sudoku</Button>
        <Button class="play_btn" margin="10" onClick={ () => { this.getSudoku() }}>Get New Sudoku</Button>
        <Button margin="10" onClick={ () => { this.changeMode() }} class={ !! this.state.noting ? "noting play_btn" : "play_btn" }>Change Mode</Button>
      </div>
    ])
  }
